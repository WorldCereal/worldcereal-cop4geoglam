"""
python scripts/create_cog_cropland.py \
  --country moldova \
...
def create_cog(
    ...
    raw_files = sorted(list(input_dir.rglob("*cropland*.tif")))
...
def main():
    ...
    final_cog = (
        postprocess_dir.parent / f"Copernicus4GEOGLAM_{country}_CropMask_2025_V3.tif"
    )
