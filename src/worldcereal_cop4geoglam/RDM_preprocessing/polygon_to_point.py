...
def polygon_to_point(activation,
                     field_polygons = "view_results_2025_polygons_v2_1.gpkg",
                     inward_buffer = 10,
                     point_distance = 10,
                     output_file="Polygon_to_points"):
    ...
    points_gdf.to_file(os.path.join(original_ref_data_dir,f"{output_file}.gpkg"), driver="GPKG")
...
if __name__ == "__main__":
    ...
    polygon_to_point(activation, field_polygons, inward_buffer, point_distance)
