...
from worldcereal_cop4geoglam.datasets import (  # MaskingMode,; MaskingStrategy,
...
LANDCOVER_KEY = "CROPLAND"
CROPTYPE_KEY = "CROPTYPE_EWOC"
...
class TestPrepareTrainingDatasets(unittest.TestCase):
    ...
    def test_prepare_training_datasets_binary(self):
        ...
        # Check dataset types
        self.assertIsInstance(train_ds, Cop4GeoLabelledDataset)
        self.assertIsInstance(val_ds, Cop4GeoLabelledDataset)
        self.assertIsInstance(test_ds, Cop4GeoLabelledDataset)
